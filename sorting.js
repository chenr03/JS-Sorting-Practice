...
const stringsToNumbs = strNums.map(string => Number(string));
...
const sumEvens = strNums.filter(number => number % 2 === 0);


console.log(sumEvens);

console.log(`Find the index of the first value when added to it's index = 512 (#ATX!!)`)
...
//
    console.log(`using a higher order function, create an array of the unique 'weather_state_name' values of the weather array. Your function should return the following array ['Light Cloud', 'Heavy Cloud', 'Showers']`)
const weatherStates = weather.map((obj) => obj.weather_state_name);

// console.log(weatherStates)

const uniqueWeatherStates = [...new Set (weatherStates)]
